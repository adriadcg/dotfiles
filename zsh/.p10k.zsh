# Generated by Powerlevel10k configuration wizard on 2022-03-11 at 16:40 CST.
...
() {
  ...
  #center separate prompt from command output. You might want to set POWERLEVEL9K_PROMPT_ADD_NEWLINE=false
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='黎'
